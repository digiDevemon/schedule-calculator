...
def it_should_return_the_expected_actual_time():
    clock = Clock()
...
def it_should_return_the_expected_actual_date():
    clock = Clock()
    today = datetime.date.today()
    assert clock.get_current_date() == today, f"It should return the expected date"
